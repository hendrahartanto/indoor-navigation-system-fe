    ...
    return (
        ...
        >
            ...
            <button
                ...
                className={`inline-flex items-center rounded-l-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 ${
              ...
              {page}
                ...
                return (
                    <button
                        ...
                        className={`inline-flex items-center border px-4 py-2 text-sm font-semibold focus:z-20 ${
                            isActive
            ...
            <button
                ...
                className={`inline-flex items-center rounded-r-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 ${
